...
const statusConfig = {
  sold: {
    ...
    validity: 'VÁLIDO',
    validityColor: 'text-success bg-success/10 border-success/30',
  },
  reserved: {
    ...
    validity: 'PENDIENTE',
    validityColor: 'text-warning bg-warning/10 border-warning/30',
  },
  available: {
    label: 'Disponible',
    ...
    validityColor: 'text-primary bg-primary/10 border-primary/30',
  },
  canceled: {
    label: 'Cancelado',
    ...
    validity: 'INVÁLIDO',
    validityColor: 'text-destructive bg-destructive/10 border-destructive/30',
  },
};
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 relative overflow-hidden">
        ...
        <div className="container-padding max-w-lg mx-auto py-8 space-y-6 relative z-10">
          {/* Verification Badge */}
          <motion.div
