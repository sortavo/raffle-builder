          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl shadow-violet-500/5 p-8 md:p-12">
            <div className="prose prose-gray max-w-none">
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">Recopilamos los siguientes tipos de información:</p>
                
                <h3 className="text-lg font-medium text-gray-800 mt-6 mb-3">2.1. Información de Cuenta</h3>
                ...
                <h3 className="text-lg font-medium text-gray-800 mt-6 mb-3">2.2. Información de Pago</h3>
                <p className="text-gray-600 leading-relaxed">
                ...
                <h3 className="text-lg font-medium text-gray-800 mt-6 mb-3">2.3. Información de Participación</h3>
                <ul className="list-disc list-inside text-gray-600 space-y-1">
                ...
                <h3 className="text-lg font-medium text-gray-800 mt-6 mb-3">2.4. Información de Dispositivo</h3>
                <ul className="list-disc list-inside text-gray-600 space-y-1">
                  <li>Dirección IP</li>
                ...
                <h3 className="text-lg font-medium text-gray-800 mt-6 mb-3" id="cookies">2.5. Cookies y Tecnologías Similares</h3>
                <p className="text-gray-600 leading-relaxed">
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">Procesamos tus datos personales bajo las siguientes bases legales:</p>
                <p className="text-gray-600 leading-relaxed">
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">Compartimos tu información con:</p>
                
                <h3 className="text-lg font-medium text-gray-800 mt-6 mb-3">5.1. Organizadores de Sorteos</h3>
                <p className="text-gray-600 leading-relaxed">
                ...
                <h3 className="text-lg font-medium text-gray-800 mt-6 mb-3">5.2. Proveedores de Servicios</h3>
                <ul className="list-disc list-inside text-gray-600 space-y-1">
                ...
                <h3 className="text-lg font-medium text-gray-800 mt-6 mb-3">5.3. Autoridades</h3>
                <p className="text-gray-600 leading-relaxed">
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">Bajo el GDPR, tienes los siguientes derechos:</p>
                <p className="text-gray-600 leading-relaxed">
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">Implementamos medidas de seguridad técnicas y organizacionales:</p>
                <p className="text-gray-600 leading-relaxed">7.1. Cifrado de datos en tránsito (TLS/SSL) y en reposo.</p>
                <p className="text-gray-600 leading-relaxed">7.2. Acceso restringido a datos personales solo al personal autorizado.</p>
                <p className="text-gray-600 leading-relaxed">7.3. Monitoreo continuo de seguridad y auditorías regulares.</p>
                <p className="text-gray-600 leading-relaxed">7.4. Copias de seguridad encriptadas y planes de recuperación ante desastres.</p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-600 leading-relaxed">10.1. Sortavo no está dirigido a menores de 18 años.</p>
                <p className="text-gray-600 leading-relaxed">10.2. No recopilamos intencionalmente información de menores de edad.</p>
                <p className="text-gray-600 leading-relaxed">
              ...
              <section>
                ...
                <div className="bg-violet-50 rounded-xl p-4 space-y-2">
                  <p className="text-gray-700"><strong>Email:</strong> privacy@sortavo.com</p>
                  <p className="text-gray-700"><strong>Responsable de Protección de Datos:</strong> dpo@sortavo.com</p>
                </div>
              </section>
            </div>
          </div>
